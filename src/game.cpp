...
{
    progressHeight = ((float)sweepCounter + (top - backgroundSweep) / (float)windowHeight) * progressBarHeight / (float)maxSweeps;
...
void Game::drawHealthIndicator()
{
    ...
    glVertex2f(left + healthIndicatorWidth + 50, top - healthIndicatorHeight - 125);
